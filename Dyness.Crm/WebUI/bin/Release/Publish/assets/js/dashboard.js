...
var Dashboard = function () {
    ...
    return {
        ...
        initCharts: function() {
            ...
            _RoundedProgressChart('#hours-available-progress', 38, 2, '#F06292', 0.68, 'icon-credit-card text-pink-400', 'Bugün Alınan Ödemeler', '150TL');
            _RoundedProgressChart('#goal-progress', 38, 2, '#5C6BC0', 0.82, 'icon-cart-remove text-indigo-400', 'Bugün Yapılan Harcamalar', '4250TL');
            _RoundedProgressChart('#goal-progress2', 38, 2, '#4DB6AC', 0.90, 'icon-quill4 text-teal-300', 'Bugün Alınan Öğrenci Kayıtları', '56 Kişi');
            ...
            _BarChart('#goal-bars2', 24, 40, true, 'elastic', 1200, 50, '#4DB6AC', 'goal');
